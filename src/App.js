...
export default class App extends Component {
  constructor() {
    super();
    this.state = {
      textarea: "This is some sample textarea input",
  ...
  onEmailInputChanged(input) {
    ...
    else this.setState({ emailValidator: true });
  }
  render() {
    var display = {
      bksp: "\u2190",
    ...
    return (
      <div>
        ...
        <h1>E-Mail Input</h1>
        <p>
          The caret cursor position is not working correctly when using
          type='email', thats why we use type='text' and an email check pattern.{" "}
          <a href="https://github.com/Mottie/Keyboard/issues/241">
            http://github.com/Mottie/Keyboard/issues/241
          </a>
        </p>
        <Keyboard
          name="emailTo"
        ...
        <span
          className={
            this.state.emailValidator ? "errormsg invalid" : "errormsg"
          }
        >
          Wrong mail address format
        </span>
      </div>
    );
  }
